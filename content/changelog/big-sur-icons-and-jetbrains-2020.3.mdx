...
- JetBrains recently launched the **2020.3 stable version**. Two months ago we released an update for that, but many users didn't download it yet, so this is a friendly reminder to get the latest version.
- Monitors are getting bigger and bigger, so we included a new **8K resolution wallpaper** for those who enjoy the extra space.
