...
cover: "/images/blog/making-a-physical-book-a.webp"
authors: ["zeno"]
---
...
![Zeno holding the physical book](/images/blog/making-a-physical-book-a.webp)

## Learning the process

Building this physical copy has been a really intense process.

At first, I hired someone on Fiverr to do the formatting. After extensive back and forth, I wasn’t happy with the quality, so I decided to do it myself.

You see, I know nothing about formatting books, but the internet is a magical place, so I started to learn Adobe InDesign.

![Adobe InDesign](/images/blog/making-a-physical-book-b.webp)
...
![Book printed at home](/images/blog/making-a-physical-book-c.webp)
...
Designing a book is complex because you have to make many decisions, like paperback vs. hardcover, white vs. creme paper, and gloss vs. matte cover.
...
![Book interior](/images/blog/making-a-physical-book-d.webp)
