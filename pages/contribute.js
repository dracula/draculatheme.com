...
class Contribute extends React.Component {
  ...
  renderFaq() {
    return (
      <div className={styles.faq}>
        ...
        <p>
          We hope so, but we need your help to accomplish that. Since you're
          already using app X you're probably much more experienced on it than
          us. So give it a try first!
        </p>
        ...
        <ol>
          ...
          <li>
            <p>
              Build the new theme using the{" "}
              <a href="#color-palette">Color Palette</a> below.
            </p>
          </li>
          <li>
            <p>
              ...
              with a link to your repository. Once the theme is accepted, we
              will move the repository under the Dracula organization and give
              you rights to maintain it :)
            </p>
          </li>
        </ol>
      </div>
  ...
  changeColorType(e) {
    ...
    if (e.value === "hex") {
      ...
      colors.map((color) => {
        color.convertedValue = `rgb(${convert.hex
          .rgb(color.value)
          .join(", ")})`;
        return color;
      });
      ...
      colors.map((color) => {
        color.convertedValue = `hsl(${convert.hex
          .hsl(color.value)
          .join(", ")})`;
        return color;
      });
    ...
    return (
      <div>
        ...
        <p>
          ...
          represent different code symbols, please see the{" "}
    ...
    return (
      <div className="single">
        <Head>
          ...
          <meta
            content="https://draculatheme.com/contribute"
            property="og:url"
          />
          <meta
