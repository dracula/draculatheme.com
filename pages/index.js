            ...
            <div className={styles.group}>
              <div className={styles.buttonGroup}>
                <button
                  ...
                  onClick={this.onFilter.bind(this, "all")}
                >
                  All
                </button>
                <button
                  className={
                    this.state.filter === "linux"
                      ? styles.buttonSelected
                      : styles.button
                  }
                  onClick={this.onFilter.bind(this, "linux")}
                >
                  Linux
                </button>
                <button
                  className={
                    this.state.filter === "mac"
                      ? styles.buttonSelected
                      : styles.button
                  }
                  onClick={this.onFilter.bind(this, "mac")}
                >
                  Mac
                </button>
                <button
                  ...
                  onClick={this.onFilter.bind(this, "windows")}
                >
                  Windows
                </button>
              </div>
