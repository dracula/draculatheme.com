    ...
    <section className="container">
      <article>
        ...
        <p>
          ...
          better again. I thought it was just a food poisoning, and I was ready
          to leave that place.{" "}
          <em>
        ...
        <p>
          ...
          <em>brought a new laptop for me</em>. I had no backup to restore from,
          so I started to install everything back again. For every code editor,
          for every terminal app, I had to choose a different theme.
        </p>
        <p>
          I always believed in the cost of context switching. I know how it
          feels when you&apos;re &quot;in the zone&quot;, then suddenly, you get
          distracted and lose focus. It shouldn&apos;t be that way, so I{" "}
          <em>decided to create my own color scheme</em>, and my mission was to
      ...
      <article>
        ...
        <p>
          ...
          was the ZSH theme. Then I moved to iTerm, Terminal.app, Sublime Text,
          and Textmate. At the end of the first day, I already had 5 themes.{" "}
          <a
        ...
        <p>
          ...
          the feeling of being sick in a foreign country, alone and away from
          your family.
        </p>
