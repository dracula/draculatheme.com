export const lessons = [
  ...
  },
  {
    ...
    content:
      "There's no 'build it and they will come'. Participate in podcasts, events and other activities to actively promote the product."
  },
  {
    title: "Viral content is bonus, not strategy",
    content:
  ...
  },
  {
    ...
    content:
      "More users generate more support demands. Increase prices to sustain service quality."
  },
  {
    title: "Adapt prices globally",
    content:
  ...
  },
  {
    ...
    content:
      "Sharing sales numbers demonstrates confidence and inspires others. True competition is surpassing previous versions of yourself."
  },
  {
    title: "Consistency beats isolated peaks",
    content:
  ...
  },
  {
    ...
    content:
      "Reaching goals is just the beginning of new challenges. Maintain continuous growth and establish new objectives."
  }
];
