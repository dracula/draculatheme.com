const paths = [
  { params: { theme: 'ableton-live', title: 'Ableton Live', repo: 'ableton-live', color: 'cyan', icon: 'pack-7/002-ghosts.svg', platform: ['mac', 'windows'] } },
  ...
  { params: { theme: 'alacritty', title: 'Alacritty', repo: 'alacritty', color: 'orange', icon: 'pack-1/006-night.svg', platform: ['all'] } },
  ...
  { params: { theme: 'base16', title: 'Base16', repo: 'base16-dracula-scheme', color: 'orange', icon: 'pack-6/040-crow.svg', platform: ['all'] } },
  ...
  { params: { theme: 'brackets', title: 'Brackets', repo: 'brackets', color: 'cyan', icon: 'pack-1/014-voodoo-doll.svg', platform: ['all'] } },
  { params: { theme: 'bspwm', title: 'bspwm', repo: 'bspwm', color: 'purple', icon: 'pack-6/022-candle.svg', platform: ['linux'] } },
  { params: { theme: 'chrome', title: 'Chrome', repo: 'google-chrome', color: 'orange', icon: 'pack-4/042-hydra.svg', platform: ['all'], synonyms: ['google'] } },
  { params: { theme: 'cmder', title: 'Cmder', repo: 'cmder', color: 'pink', icon: 'pack-1/010-trident.svg', platform: ['windows'] } },
  { params: { theme: 'coda', title: 'Coda', repo: 'coda', color: 'pink', icon: 'pack-1/013-lollipop.svg', platform: ['mac'] } },
  { params: { theme: 'conemu', title: 'ConEmu', repo: 'conemu', color: 'orange', icon: 'pack-1/025-candle-1.svg', platform: ['windows'] } },
  ...
  { params: { theme: 'duckduckgo', title: 'DuckDuckGo', repo: 'duckduckgo', color: 'pink', icon: 'pack-1/019-spider.svg', platform: ['all'] } },
  ...
  { params: { theme: 'figma', title: 'Figma', repo: 'figma', color: 'orange', icon: 'pack-1/015-makeup.svg', platform: ['all'] } },
  ...
  { params: { theme: 'fluent-terminal', title: 'Fluent Terminal', repo: 'fluent-terminal', color: 'cyan', icon: 'pack-1/034-eye.svg', platform: ['windows'] } },
  ...
  { params: { theme: 'gedit', title: 'Gedit', repo: 'gedit', color: 'purple', icon: 'pack-1/029-werewolf.svg', platform: ['all'] } },
  ...
  { params: { theme: 'gmk', title: 'GMK', repo: 'gmk', color: 'orange', icon: 'pack-5/012-spell book.svg', platform: ['all'] } },
  { params: { theme: 'gnome-terminal', title: 'Gnome Terminal', repo: 'gnome-terminal', color: 'orange', icon: 'pack-1/042-candle.svg', platform: ['linux'] } },
  { params: { theme: 'godot', title: 'Godot', repo: 'godot', color: 'pink', icon: 'pack-7/024-skeleton.svg', platform: ['all'] } },
  { params: { theme: 'highlightjs', title: 'Highlight.js', repo: 'highlightjs', color: 'cyan', icon: 'pack-1/044-spider-web.svg', platform: ['all'] } },
  { params: { theme: 'hyper', title: 'Hyper', repo: 'hyper', color: 'purple', icon: 'pack-3/048-unicorn.svg', platform: ['all'] } },
  ...
  { params: { theme: 'iterm', title: 'iTerm', repo: 'iterm', color: 'purple', icon: 'pack-1/030-clown.svg', platform: ['mac'] } },
  ...
  { params: { theme: 'kate', title: 'Kate', repo: 'kate', color: 'orange', icon: 'pack-5/039-flask.svg', platform: ['all'] } },
  { params: { theme: 'kitty', title: 'Kitty', repo: 'kitty', color: 'cyan', icon: 'pack-4/044-werewolf.svg', platform: ['all'] } },
  { params: { theme: 'konsole', title: 'Konsole', repo: 'konsole', color: 'orange', icon: 'pack-1/049-bats.svg', platform: ['linux'] } },
  ...
  { params: { theme: 'macdown', title: 'MacDown', repo: 'macdown', color: 'cyan', icon: 'pack-1/047-cleaver.svg', platform: ['mac'] } },
  { params: { theme: 'mattermost', title: 'Mattermost', repo: 'mattermost', color: 'orange', icon: 'pack-1/002-coffin.svg', platform: ['all'] } },
  { params: { theme: 'mindnode', title: 'MindNode', repo: 'mindnode', color: 'purple', icon: 'pack-5/008-wizard.svg', platform: ['mac'] } },
  { params: { theme: 'mintty', title: 'Mintty', repo: 'mintty', color: 'orange', icon: 'pack-4/043-minotaur.svg', platform: ['windows'] } },
  ...
  { params: { theme: 'notepad-plus-plus', title: 'Notepad++', repo: 'notepad-plus-plus', color: 'orange', icon: 'pack-1/048-frankenstein.svg', platform: ['windows'] } },
  { params: { theme: 'nylas-n1', title: 'Nylas N1', repo: 'nylas-n1', color: 'cyan', icon: 'pack-1/032-bat.svg', platform: ['all'] } },
  { params: { theme: 'oracle-sql-developer', title: 'Oracle SQL Developer', repo: 'oracle-sql-developer', color: 'cyan', icon: 'pack-1/036-spellbook.svg', platform: ['all'] } },
  { params: { theme: 'powershell', title: 'PowerShell', repo: 'powershell', color: 'purple', icon: 'pack-5/046-magic trick.svg', platform: ['all'] } },
  { params: { theme: 'prism', title: 'Prism', repo: 'prism', color: 'pink', icon: 'pack-7/005-candies.svg', platform: ['all'] } },
  { params: { theme: 'pygments', title: 'Pygments', repo: 'pygments', color: 'orange', icon: 'pack-3/027-magician-hat-1.svg', platform: ['all'] } },
  { params: { theme: 'pythonista', title: 'Pythonista', repo: 'pythonista', color: 'purple', icon: 'pack-6/048-grave.svg', platform: ['mac'] } },
  { params: { theme: 'qtcreator', title: 'Qt Creator', repo: 'qtcreator', color: 'orange', icon: 'pack-3/043-snake.svg', platform: ['all'] } },
  ...
  { params: { theme: 'sequel-pro', title: 'Sequel Pro', repo: 'sequel-pro', color: 'orange', icon: 'pack-4/016-axe.svg', platform: ['mac'] } },
  { params: { theme: 'sketch', title: 'Sketch', repo: 'sketch', color: 'cyan', icon: 'pack-3/025-magic-wand-1.svg', platform: ['all'] } },
  { params: { theme: 'slack', title: 'Slack', repo: 'slack', color: 'purple', icon: 'pack-6/030-graveyard.svg', platform: ['all'] } },
  ...
  { params: { theme: 'sublime', title: 'Sublime', repo: 'sublime', color: 'cyan', icon: 'pack-2/046-ghost.svg', platform: ['all'] } },
  ...
  { params: { theme: 'terminal', title: 'Terminal.app', repo: 'terminal-app', color: 'purple', icon: 'pack-5/047-mortar.svg', platform: ['mac'] } },
  { params: { theme: 'termite', title: 'Termite', repo: 'termite', color: 'cyan', icon: 'pack-3/037-voodoo-doll.svg', platform: ['linux'] } },
  { params: { theme: 'termux', title: 'Termux', repo: 'termux', color: 'purple', icon: 'pack-3/002-spellbook.svg', platform: ['all'] } },
  { params: { theme: 'textmate', title: 'Textmate', repo: 'textmate', color: 'cyan', icon: 'pack-1/038-tombstone.svg', platform: ['mac'] } },
  { params: { theme: 'textual', title: 'Textual', repo: 'textual', color: 'orange', icon: 'pack-5/045-hourglass.svg', platform: ['mac'] } },
  { params: { theme: 'tilix', title: 'Tilix', repo: 'tilix', color: 'cyan', icon: 'pack-1/039-ghost.svg', platform: ['linux'] } },
  { params: { theme: 'tmux', title: 'tmux', repo: 'tmux', color: 'pink', icon: 'pack-7/042-haunted house.svg', platform: ['linux', 'mac'] } },
  { params: { theme: 'total-commander', title: 'Total Commander', repo: 'total-commander', color: 'cyan', icon: 'pack-7/022-mummy.svg', platform: ['windows'] } },
  { params: { theme: 'typora', title: 'Typora', repo: 'typora', color: 'purple', icon: 'pack-1/017-witch-1.svg', platform: ['all'] } },
  { params: { theme: 'ulauncher', title: 'Ulauncher', repo: 'ulauncher', color: 'orange', icon: 'pack-3/034-pot.svg', platform: ['linux'] } },
  { params: { theme: 'ulysses', title: 'Ulysses', repo: 'ulysses', color: 'orange', icon: 'pack-5/033-smoke.svg', platform: ['mac'] } },
  ...
  { params: { theme: 'visual-studio', title: 'Visual Studio', repo: 'visual-studio', color: 'orange', icon: 'pack-3/035-potion-1.svg', platform: ['all'] } },
  { params: { theme: 'visual-studio-code', title: 'Visual Studio Code', repo: 'visual-studio-code', color: 'purple', icon: 'pack-1/041-skeleton.svg', platform: ['all'], synonyms: ['vscode'] } },
  ...
  { params: { theme: 'wing', title: 'Wing', repo: 'wing', color: 'cyan', icon: 'pack-5/024-cauldron.svg', platform: ['all'] } },
  ...
  { params: { theme: 'xcode', title: 'Xcode', repo: 'xcode', color: 'pink', icon: 'pack-6/004-reaper.svg', platform: ['mac'] } },
  { params: { theme: 'xresources', title: 'Xresources', repo: 'xresources', color: 'purple', icon: 'pack-1/035-cauldron.svg', platform: ['all'] } },
  { params: { theme: 'zsh', title: 'Zsh', repo: 'zsh', color: 'orange', icon: 'pack-6/042-corpse.svg', platform: ['all'] } },
];
