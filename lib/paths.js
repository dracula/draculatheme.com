const paths = [
  ...
  { params: { theme: 'base16', title: 'Base16', repo: 'base16-dracula-scheme', color: 'orange', icon: 'pack-1/033-black-cat.svg', platform: ['all'] } },
  ...
  { params: { theme: 'kakoune', title: 'Kakoune', repo: 'kakoune', color: 'orange', icon: 'pack-6/040-crow.svg', platform: ['linux'] } },
