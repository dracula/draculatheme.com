...
module.exports = {
  ...
  exportPathMap: async function() {
    const paths = {
      ...
      '/pro': { page: '/pro', query: {} },
      '/adobe': { page: '/[theme]', query: { title: 'Adobe', repo: 'adobe', color: 'purple', icon: 'hat-magic.png' } },
      ...
      '/figma': { page: '/[theme]', query: { title: 'Figma', repo: 'figma', color: 'cyan', icon: 'spider.png' } },
      ...
      '/sketch': { page: '/[theme]', query: { title: 'Sketch', repo: 'sketch', color: 'orange', icon: 'candies.png' } },
