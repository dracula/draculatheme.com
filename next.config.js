...
module.exports = {
  ...
  exportPathMap: async function() {
    const paths = {
      ...
      '/pro': { page: '/pro', query: {} },
      '/adobe': { page: '/[theme]', query: { title: 'Adobe', repo: 'adobe', color: 'pink', icon: 'pack-6/039-zombie.svg', platform: ['mac', 'windows'], synonyms: ['photoshop', 'illustrator'] } },
      ...
      '/chrome': { page: '/[theme]', query: { title: 'Chrome', repo: 'google-chrome', color: 'orange', icon: 'pack-4/042-hydra.svg', platform: ['all'], synonyms: ['google'] } },
      ...
      '/jetbrains': { page: '/[theme]', query: { title: 'JetBrains', repo: 'jetbrains', color: 'pink', icon: 'pack-1/046-zombie.svg', platform: ['all'], synonyms: ['intellij', 'pycharm', 'webstorm', 'phpstorm', 'rider', 'clion', 'datagrip', 'rubymine', 'appcode', 'goland'] } },
      ...
      '/visual-studio-code': { page: '/[theme]', query: { title: 'Visual Studio Code', repo: 'visual-studio-code', color: 'purple', icon: 'pack-1/041-skeleton.svg', platform: ['all'], synonyms: ['vscode'] } },
