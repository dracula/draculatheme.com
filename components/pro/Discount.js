...
class Discount extends Component {
	renderSpecialMessage() {
		...
		return (
			<p>
				I believe in{" "}
				<span className={styles.highlight}>Purchasing Parity Power</span>, and I
						...
						<div className={styles.bodyLeft}>
							<div className={styles.flagContainer}>
								<img
									...
									src={`/static/img/flags/${this.props.ppp.country}.svg`}
									alt={countries[this.props.ppp.country].name}
									width="200"
								/>
							</div>
						</div>
						<div className={styles.bodyRight}>
							<p>
								...
								<span className={styles.highlight}>
									{countries[this.props.ppp.country].name}
								</span>{" "}
							...
							<p>
								...
								for an extra{" "}
								<span className={styles.highlight}>{this.props.ppp.discount}% off</span>{" "}
								the regular price.
							</p>
						</div>
					</div>
