    ...
    return <div className={styles.why}>
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <p className={styles.body}>In 2013, <Link href="/about"><a className={styles.link}>my laptop was stolen</a></Link> and I had to re-configure everything. At that time, there were thousands of themes out there, but none of them were appealing to me. So I decided to <span className={styles.highlight}>create my own</span>.</p>
