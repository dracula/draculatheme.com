				...
				<div className={styles.container}>
					...
					<div className={styles.contentRight}>
						<svg
							...
							viewBox="0 0 512 512"
						>
							<title>ionicons-v5-glasses</title>
						...
						<p className={styles.body}>
							You can have the best theme, font, and tooling in the world, but if you
							cultivate bad habits, it will be hard for you to{" "}
							<span className={styles.highlight}>become a top developer</span>.
						</p>
						<p className={styles.body}>
							Because of that, I decided to reach out to the best developers I know and
							ask them tips on{" "}
							<span className={styles.highlight}>how to be more productive</span>.
						</p>
						<p className={styles.body}>
							This book is a collection of valuable learnings from senior
							professionals.
						</p>
						<a href="https://14habits.com" target="_blank" className={styles.cta}>
							Learn more
						</a>
					</div>
				</div>
