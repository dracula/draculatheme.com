    ...
    return <div className={styles.ebook}>
      <div className={styles.container}>
        ...
        <div className={styles.contentRight}>
          ...
          <p className={styles.body}>This book is a collection of valuable learnings from senior professionals.</p>
