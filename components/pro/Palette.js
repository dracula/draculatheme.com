				...
				<div className={styles.container}>
					<div className={styles.contentLeft}>
						...
						<img
							...
							src="/static/img/pro/wheel-dracula.png"
							alt="Classic Palette"
							loading="lazy"
						...
						<img
							className={styles.paletteImage}
							src="/static/img/pro/wheel-dracula-pro.png"
							alt="PRO Palette"
							loading="lazy"
						/>
					</div>
					<div className={styles.contentRight}>
						<svg
							...
							viewBox="0 0 512 512"
						>
							<title>ionicons-v5-color-wand</title>
						...
						<p className={styles.body}>
							Isaac Newton was one of the first to organize colors geometrically. In
							1704, Newton observed the relationships between different wavelengths of
							light and organized them as a{" "}
							<span className={styles.highlight}>circle of hue</span>.
						</p>
						<p className={styles.body}>
							{" "}
							He was then able to identify different patterns that arose out of this
							representation. This would become the foundation of{" "}
							<span className={styles.highlight}>modern color theory</span>.
						</p>
						<p className={styles.body}>
							The original Dracula colors created in 2013 were based on personal taste.
							This new PRO version brings a more refined and{" "}
							<span className={styles.highlight}>mathematical approach</span> that
							normalizes lightness and saturation.
						</p>
