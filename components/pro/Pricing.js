...
class Pricing extends Component {
  render() {
    ...
    let beforePrice = 79;
    let afterPrice = 47;
    let gumroadURL = 'https://gum.co/dracula-pro/cyb3rm0nd3y?wanted=true';
    ...
    return <div id="get" className={styles.pricing}>
      <div className={styles.container}>
        ...
        <p className={styles.body}>Join <span className={styles.highlight}>{this.props.sales.count} developers</span> using Dracula PRO every day.</p>
