...
class Pricing extends Component {
	renderPrimary() {
		...
		return (
			<Box rounded="2xl" className={styles.primaryTable}>
				<Paragraph color="cyanGreen" className={styles.packageName}>
					Complete Package
				</Paragraph>
				<Paragraph my="sm" className={styles.primaryPrice}>
					<Text className={styles.primaryBeforePrice}>${beforePrice}</Text>$
					{afterPrice}
				</Paragraph>
				...
				<Paragraph className={styles.refund}>30 days refund (no Q/A)</Paragraph>
			</Box>
		);
	}
	...
	renderSecondary() {
		...
		return (
			<Box className={styles.secondaryTable}>
				<Paragraph className={styles.packageName}>Essential Package</Paragraph>
				<Paragraph my="sm" className={styles.secondaryPrice}>
					<Text className={styles.secondaryBeforePrice}>${beforePrice}</Text>$
					{afterPrice}
				</Paragraph>
				<List variant="none" m="none">
					<li>
	...
	render() {
		return (
			<Box id="get" className={styles.pricing}>
				...
				<Box className={styles.container}>
					<Heading size="2xl" className={styles.title}>
						Join the Dark Side
					</Heading>
					<Paragraph
						size="lg"
					...
					>
						Get early access to dozens of components and start building gorgeous dark
						sites today.
					</Paragraph>
					<Box className={styles.tables}>{this.renderPrimary()}</Box>
				</Box>
