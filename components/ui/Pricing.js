...
import { Button, Box, List, Paragraph, Heading, Text } from '@dracula/dracula-ui';

class Pricing extends Component {
  renderPrimary() {
    let beforePrice = 149;
    let afterPrice = 79;
    let gumroadURL = 'https://gum.co/dracula-ui';

    if (this.props.ppp.country && this.props.ppp.discount) {
      beforePrice = 149;
      afterPrice = getDiscount(beforePrice, this.props.ppp.discount);
      gumroadURL = `https://gumroad.com/l/dracula-ui/${this.props.ppp.country}UI`;
    }
  ...
  render() {
    return <Box id="get" className={styles.pricing}>
      ...
      <Box className={styles.container}>
        ...
        <Paragraph size="lg" lineHeight="md" mt="sm" mb="lg" className={styles.description}>
