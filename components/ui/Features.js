        ...
        <div className={styles.contentLeft}>
          <div className={styles.iconContainerFirst}>
            ...
            >
              ...
              />
              <path
                className={styles.secondaryFirst}
                d="M15 21a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2 1 1 0 0 1 0-2h6a1 1 0 0 1 0 2z"
              />
            </svg>
          </div>
          <Heading size="2xl" pb="sm">
            Built for Dark Mode
          </Heading>
          <Paragraph pb="sm" className={styles.paragraph}>
            Most templates are built using light colors and later on{' '}
            <Text className={styles.highlight}>adapted to dark colors</Text>.
          </Paragraph>
          <Paragraph pb="sm" className={styles.paragraph}>
            Dark themes shouldn't be an afterthought, they should be a{' '}
            <Text className={styles.highlight}>top priority</Text>.
          </Paragraph>
        </div>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.contentRightInverted}>
          <div className={styles.iconContainerSecond}>
            ...
            >
              <path
                className={styles.primarySecond}
              ...
              />
              <path
                className={styles.secondarySecond}
          ...
          <Paragraph pb="sm" className={styles.paragraph}>
            Speed up the prototyping phase by using a highly configurable{' '}
            <Text className={styles.highlight}>Design System</Text>.
          </Paragraph>
          <Paragraph pb="sm" className={styles.paragraph}>
            Collaborate easily by taking advantage of a carefully crafted{' '}
            <Text className={styles.highlight}>Figma</Text> file.
          </Paragraph>
        </div>
      </div>
    )
    ...
    return (
      <div className={styles.content}>
        <div className={styles.contentLeft}>
          <div className={styles.iconContainerThird}>
            ...
            >
              <rect
                ...
                x="3"
                y="3"
                className={styles.primaryThird}
                rx="2"
              />
              <path
                className={styles.secondaryThird}
          ...
          <Paragraph pb="sm" className={styles.paragraph}>
            Don't worry about class names, just use the{' '}
            <Text className={styles.highlight}>Visual Studio Code</Text> code
            snippets.
          </Paragraph>
          <Paragraph pb="sm" className={styles.paragraph}>
            You can take advantage of autocomplete and also access the{' '}
            <Text className={styles.highlight}>entire documentation</Text> right
